...
// Step 3 of Member self-signup: pick a subscription plan. Plans are entirely
    ...
    return (
        <div className="mx-auto max-w-4xl p-6 sm:p-10">
            <div className="text-center">
                ...
                <p className="mt-2 text-sm text-text-secondary">Pick the plan that matches how many clients you plan to manage. You can upgrade later.</p>
            </div>

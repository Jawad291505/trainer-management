...
// A Trainer whose paid period has lapsed. The backend rejects everything except
...
export default function PlanExpired() {
    ...
    const expiry = user?.trainer?.planExpiryDate
    ...
    return (
        <div className="mx-auto max-w-lg p-6 sm:p-10">
            <Result
                ...
                subTitle={`${expiry ? `Your plan ended on ${dayjs(expiry).format('D MMM YYYY')}. ` : ''}Contact your administrator to renew — your clients and data are kept safe and will be available again as soon as it's renewed.`}
                extra={[

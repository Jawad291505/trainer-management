...
router.post('/foods', authorize('admin', 'trainer'), createFood)
router.patch('/foods/:id', authorize('admin', 'trainer'), updateFood)
router.delete('/foods/:id', authorize('admin', 'trainer'), deleteFood)
...
router.post('/exercises', authorize('admin', 'trainer'), createExercise)
router.patch('/exercises/:id', authorize('admin', 'trainer'), updateExercise)
router.delete('/exercises/:id', authorize('admin', 'trainer'), deleteExercise)

// ---- Nutrition config + ad-hoc calculators ----
router.get('/nutrition/config', getConfig)
router.put('/nutrition/config', authorize('admin'), updateConfig)
